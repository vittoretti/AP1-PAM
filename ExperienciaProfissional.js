...
export default function ExperienciaProfissional() {
  ...
  return (
    ...
    <StatusBar backgroundColor="#4169E1" />
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <KeyboardAvoidingView
          ...
          <Text style={styles.title}> Tela de Cadastro </Text>
           <Text style={styles.label}> Escreva sobre sua experiência profissional.</Text>
            <Card style={styles.card}>
              <Text>Nome:</Text>
              <TextInput
                style={styles.input}
                placeholder="Instituto XXXX, Cargo, São Paulo DD/MM/AAAA"
                multiline={true}          
                numberOfLines={10}         
      ...
      <Button
      mode={'contained'}
      onPress={() => navigation.navigate('Comp. Técnicas')} 
      icon='arrow-right'
      style={styles.button}
      >
      Próxima Tela
